...
patterns, we base our representation on a family of \texttt{lark} grammars
that describe typed pattern expressions (e.g., notes, numbers, booleans,
time values).
...
while terminal symbols represent note names, sample identifiers and numeric
literals.

Concretely, the import-closed grammar used in our experiments spans 13 Lark
modules and 239 production rules.
A static analysis of the symbol dependency graph reveals 45 distinct terminal
...
\begin{figure}[!t]
  \centering
  % \includegraphics[width=\linewidth]{figures/pattern_tree.pdf}
  \caption{Example pattern tree corresponding to a short TidalCycles pattern,
  illustrating the hierarchical combination of timing, layering and sound
  selection operators.}
...
% TODO: Describe target audio clips, evolution parameters, implementation
% details and runtime considerations.

\subsection{Results}
% TODO: Present convergence plots, quantitative metrics and qualitative
% analysis of evolved patterns versus the target.

\section{Discussion}
% TODO: Discuss strengths and limitations of the approach, interpret the
% results and relate them back to the problem statement and related work.

\section{Future Work}
% TODO: Outline possible extensions, including algorithmic improvements,
% richer grammars and interactive or real-time scenarios.

\section{Conclusion}
% TODO: Summarize the overall approach, main findings and key takeaways of
% the project in a concise way.
